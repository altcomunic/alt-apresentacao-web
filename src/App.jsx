  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      ...
      <main>
                ...
                >
                  ...
                  <div className="relative flex h-full min-h-[560px] flex-col justify-between p-8 md:p-10">
                    ...
                    <div>
                      ...
                      <button className="mt-8 inline-flex items-center gap-4 border border-white/30 px-5 py-3 text-xs font-semibold uppercase tracking-[0.18em] transition group-hover:bg-white group-hover:text-black">
                        Ver projeto
                        <ArrowRight size={16} />
                      </button>
                    </div>
        ...
        <section className="relative min-h-[640px] overflow-hidden px-5 py-28 md:px-14 md:py-36">
